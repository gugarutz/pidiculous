...
def lasssprudeln(strip, r, g, b, wait_ms=50):
    for i in range(strip.numPixels()):
        ...
        strip.setPixelColor(i+1, strip.Color(r*0.8, g*0.8, b*0.8))
        strip.setPixelColor(i+2, strip.Color(r*0.7, g*0.7, b*0.7))
        strip.setPixelColor(i+3, strip.Color(r*0.6, g*0.6, b*0.6))
        strip.setPixelColor(i+4, strip.Color(r*0.4, g*0.4, b*0.4))
        strip.setPixelColor(i+4, strip.Color(r*0.2, g*0.2, b*0.4))
        strip.setPixelColor(i+4, strip.Color(r*0, g*0, b*0))
        strip.show()
        time.sleep(wait_ms / 1000.0)
